       ...
       //creamos un JSON que tendrá los datos de la nueva película
        ...
        fetch(url, settings)
            ...
            if(data.status==200){
                 ...
                 let successAlert2 = '<div class="alert alert-success alert-dismissible">' +
                     '<button type="button" class="close" data-dismiss="alert">&times;</button>' +
                     '<strong></strong> Odontólogo agregado </div>'

                 document.querySelector('#response').innerHTML = "Odontologo agregado";
...
let errorAlert2 = '<div class="alert alert-danger alert-dismissible">' +
                                     '<button type="button" class="close" data-dismiss="alert">&times;</button>' +
                                     '<strong> Error intente nuevamente</strong> </div>'

                      document.querySelector('#response').innerHTML = '<div class="alert alert-danger"><strong> Error intente nuevamente</strong></div>';
                      document.querySelector('#response').style.display = "block";
}
            })
            .catch(error => {
